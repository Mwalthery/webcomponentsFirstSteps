...
.theme-toggle__fixed{
  ...
  render() {
    if (this.isFixed == true) {
      return html`
    <div><h1 class="theme-toggle__fixed" :class="${this.currentTheme}" @click="${this._setTheme}">theme-switch</h1></div>
        `;
    } else {
      return html`
    <div><h1 class="theme-toggle__floating" :class="${this.currentTheme}" @click="${this._setTheme}">theme switch</h1></div>
        `;
    }
