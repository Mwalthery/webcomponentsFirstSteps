...
.theme-toggle__fixed{
  ...
  render() {
    if (this.isFixed) {
      return html`
    <div><h1 class="theme-toggle__fixed ${this.currentTheme}" @click="${this._setTheme}">theme-switch</h1></div>
        `;
    } else {
      return html`
    <div><h1 class="theme-toggle__floating ${this.currentTheme}" @click="${this._setTheme}">theme switch</h1></div>
        `;
    }
